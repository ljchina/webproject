...
_extend(KUploadButton, {
	init : function(options) {
		...
		var html = [
			...
			'<span class="ke-button-common" style="margin-top:302px;width:50px">选择上传',
			hiddenElements.join(''),
			'<input type="button" class="ke-button-common ke-button"  style="margin-top:302px" value="' + title + '" />',
			'</span>',
			'<input type="file" class="ke-upload-file" style="margin-top:302px" name="' + fieldName + '" tabindex="-1" />',
...
KindEditor.plugin('multiimage', function(K) {
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			fileTypes : '*.jpg;*.jpeg;*.gif;*.png;*.bmp,*.JPG;*.JPEG;*.GIF;*.PNG;*.BMP',
