	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="/SprindMvcDemo/information.do"><span class="glyphicon glyphicon-list"></span> 资讯</a></li>
				<li><a href="/SprindMvcDemo/case.do"><span class="glyphicon glyphicon-fire"></span> 商品</a></li>
				<li class="active"><a href="/SprindMvcDemo/about.do"><span class="glyphicon glyphicon-question-sign"></span> 关于我们</a></li>
